...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  //TInstall初始化
  [TInstall initInstall:@"2O46BV" setHost:@"https://feaffcodegetm3.com"];
  
  // Piwik 統計
  [PiwikTracker sharedInstanceWithSiteID:@"2d7472ee-2c34-4426-b638-c73dae1addca" baseURL:[NSURL URLWithString:@"https://analytics.ravelz.com"]];
  ...
  /* Umeng init */
  [RNUMConfigure initWithAppkey:@"6285d00d38b8e30d038ffa3c" channel:@"App Store"];
...
//  NSLog(@"canWork = %d",[[FaceSDKManager sharedInstance] canWork]);
 ...
 [rootView setFrame:[UIScreen mainScreen].bounds];
  ...
  //smartlook 
  SLSetupConfiguration *slConfig = [[SLSetupConfiguration alloc] initWithKey:@"00ea837a4be22a651016e4f9be501ce18db78e64"];

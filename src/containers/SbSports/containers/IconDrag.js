...
class IconDrag extends React.Component {
    ...
    **/
    ...
    render() {  
        const { useLocalSrc = false } = this.props;
        return (
            ...
            <View {...this._panResponder.panHandlers} style={[styles.circle, this.state.style]}>
                ...
                <Touch style={{ width: CIRCLE_SIZE, height: CIRCLE_SIZE + 45 }} onPress={() => this.props.chickButton()}>
                    {useLocalSrc?(
                      <Image defaultSource={require('../images/loding.png')} source={this.props.iconUrls} resizeMode={'contain'} style={{ width: CIRCLE_SIZE, height: CIRCLE_SIZE + 45 }} />
                    ):(
